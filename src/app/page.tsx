  ...
  return (
    <div className="space-y-16">
      ...
      <section className="grid md:grid-cols-3 gap-8">
        <div className="space-y-3 p-6 rounded-xl border border-zinc-800 bg-zinc-900/50">
          ...
          <pre className="text-xs bg-zinc-950 p-3 rounded-lg text-emerald-400 overflow-x-auto">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <a key={b.slug} href={`/threads?board=${b.slug}`}
